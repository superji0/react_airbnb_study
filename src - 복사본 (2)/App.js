  ...
  return (
    <div className="App">
      ...
      <Route path="/" element={ <Main /> } />
        ...
        <Route path="/contents1" element={ <Contents1 sea={sea} totalData={totalData} /> } />
        <Route path="/contents2" element={ <Contents2 pool={pool} totalData={totalData2} /> } />
        <Route path="/contents3" element={ <Contents3 country={country} totalData={totalData3} /> } />
        <Route path="/contents4" element={ <Contents4 city={city} totalData={totalData4} /> } />
      </Routes>
